                            ...
                            <div class="py-2 align-middle min-w-full sm:px-6 lg:px-8">
                                ...
                                <div class="container py-6">
                                    <div
                                        ...
                                        <p class="">Matrimonio Director de Sesión</p> <!-- border-b-4 -->
                                    </div>
                                    ...
                                    <div
                                        class="grid grid-cols-1 gap-4 place-content-center text-3xl text-center text-gray-900 border-b-2 mb-6 font-bold">
                                        <p class="">Matrimonio Director de Logística</p>
                                        <!-- border-b-4 -->
                                    </div>
                                    <div class="grid md:grid-cols-2 sm:grid-cols-1 gap-4 place-content-center mt-4">
                                        <div class="text-center">
                                                ...
                                                justify-content: center;">
                                                            <div class="flex justify-center">
                                                                <div
                                                                    ...
                                                                    <div
                                                                        class="py-3 px-6 rounded-lg  border-b border-gray-300 font-extrabold {{ $color }}">
                                                                        {{ $texto }}
                                                                    </div>
                                                                    <div class="p-6">
                                                                        <h5
                                                                            class="text-gray-900 text-xl font-medium mb-2">
                                                                            {{ $anuncio->descripcion }}</h5>
